    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('new_url', fluent_pages.pagetypes.redirectnode.fields.UrlField(max_length=300, verbose_name='New URL')),
                ...
                ('master', models.ForeignKey(related_name=b'redirect_translations', editable=False, to='redirectnode.RedirectNode', null=True)),
            ],
            options={
