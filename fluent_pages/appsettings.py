...
# Note: the default language setting is also used during the migrations
FLUENT_PAGES_DEFAULT_LANGUAGE_CODE = getattr(settings, 'FLUENT_PAGES_DEFAULT_LANGUAGE_CODE', settings.LANGUAGE_CODE)
FLUENT_PAGES_ENABLE_DEFAULT_LANGUAGE_URLS = getattr(settings, 'FLUENT_PAGES_ENABLE_DEFAULT_LANGUAGE_URLS', False)
