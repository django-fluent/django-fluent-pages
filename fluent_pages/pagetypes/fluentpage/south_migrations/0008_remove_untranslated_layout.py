...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FluentPage.layout'
        db.delete_column('pagetype_fluentpage_fluentpage', 'layout_id')


    def backwards(self, orm):
        # Adding field 'FluentPage.layout'
        db.add_column('pagetype_fluentpage_fluentpage', 'layout',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fluent_pages.PageLayout'], null=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'fluentpage.fluentpagetranslation': {
            ...
            'master': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'page_translations'", 'to': u"orm['fluentpage.FluentPage']"})
        },
        u'sites.site': {
