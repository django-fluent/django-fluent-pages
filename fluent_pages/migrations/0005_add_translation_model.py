...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        if not db.dry_run:
            for urlnode in orm['fluent_pages.UrlNode']:
                try:
                    translation =  urlnode.translations.get(language_code=settings.LANGUAGE_CODE)
                except ObjectDoesNotExist:
                    translation = urlnode.translations.get(language_code__in=('en_US', 'en'))
