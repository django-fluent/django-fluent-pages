...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'FluentPageTranslation.layout_translated'
        db.rename_column('fluentpage_fluentpagetranslation', 'layout_translated_id', 'layout_id')

    def backwards(self, orm):
        # Renaming field 'FluentPageTranslation.layout'
        db.rename_column('fluentpage_fluentpagetranslation', 'layout_id', 'layout_translated_id')
