...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FluentPage.meta_description'
        db.delete_column('pagetype_fluentpage_fluentpage', 'meta_description')

        # Deleting field 'FluentPage.meta_title'
        db.delete_column('pagetype_fluentpage_fluentpage', 'meta_title')

        # Deleting field 'FluentPage.meta_keywords'
        db.delete_column('pagetype_fluentpage_fluentpage', 'meta_keywords')


    def backwards(self, orm):
        # Adding field 'FluentPage.meta_description'
        db.add_column('pagetype_fluentpage_fluentpage', 'meta_description',
        ...
        # Adding field 'FluentPage.meta_keywords'
        db.add_column('pagetype_fluentpage_fluentpage', 'meta_keywords',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
