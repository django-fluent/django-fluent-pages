...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UrlNode.login_required'
        db.add_column(u'fluent_pages_urlnode', 'login_required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UrlNode.login_required'
        db.delete_column(u'fluent_pages_urlnode', 'login_required')
