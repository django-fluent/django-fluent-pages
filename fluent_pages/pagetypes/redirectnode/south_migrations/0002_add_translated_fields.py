...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RedirectNodeTranslation'
        ...
        db.send_create_signal(u'redirectnode', ['RedirectNodeTranslation'])

        # Adding unique constraint on 'RedirectNodeTranslation', fields ['language_code', u'master']
        db.create_unique(u'redirectnode_redirectnode_translation', ['language_code', u'master_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'RedirectNodeTranslation', fields ['language_code', u'master']
        db.delete_unique(u'redirectnode_redirectnode_translation', ['language_code', u'master_id'])

        # Deleting model 'RedirectNodeTranslation'
        db.delete_table(u'redirectnode_redirectnode_translation')
    ...
    models = {
        ...
        u'redirectnode.redirectnodetranslation': {
            'Meta': {'unique_together': "[(u'language_code', u'master')]", 'object_name': 'RedirectNodeTranslation', 'db_table': "u'redirectnode_redirectnode_translation'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
