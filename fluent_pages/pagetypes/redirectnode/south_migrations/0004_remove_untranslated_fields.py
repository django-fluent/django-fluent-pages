...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RedirectNode.new_url'
        db.delete_column('pagetype_redirectnode_redirectnode', 'new_url')

        # Deleting field 'RedirectNode.redirect_type'
        db.delete_column('pagetype_redirectnode_redirectnode', 'redirect_type')
    ...
    def backwards(self, orm):
        ...
        db.add_column('pagetype_redirectnode_redirectnode', 'redirect_type',
